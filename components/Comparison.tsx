...
export function Comparison() {
  return (
    <section className="px-6 py-20 md:py-28 bg-[var(--color-soft)]">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="rounded-2xl bg-white border border-black/5 overflow-hidden">
          <div className="grid grid-cols-[1fr_110px_110px] md:grid-cols-[1fr_140px_140px] bg-[var(--color-ink)] text-[var(--color-cream)] text-sm">
          ...
          {ROWS.map((row, i) => (
            ...
            >
              ...
              <div className="p-4 text-center text-[var(--color-pink-deep)] text-xl font-bold" aria-label="Play centre: no">✗</div>
              <div className="p-4 text-center text-[var(--color-mint-deep)] text-xl font-bold" aria-label="KiddoKlub: yes">✓</div>
            </motion.div>
          ))}
        </div>
      </div>
