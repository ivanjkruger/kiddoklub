      ...
      <div className="px-6 pt-12 pb-16 md:pt-20 md:pb-24 max-w-6xl mx-auto md:grid md:grid-cols-12 md:gap-10 md:items-center">
        ...
        <div className="md:col-span-7">
          <motion.p
            ...
            className="uppercase tracking-[0.2em] text-xs text-[var(--color-muted)] mb-3"
          >
            Doha&apos;s softest play setups
          </motion.p>
          <motion.h1
          ...
          <motion.p
            ...
            className="text-lg text-[var(--color-muted)] max-w-xl mb-7"
          >
            Bespoke soft-play, ball pits, and themed styling; delivered, set up, sanitized, and collected. We bring the play, you take the photos.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[var(--color-terracotta)] text-white px-6 py-3 font-medium hover:scale-[1.02] transition-transform"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M.057 24l1.687-6.163a11.867 11.867 0 0 1-1.587-5.946C.16 5.335 5.495 0 12.05 0a11.817 11.817 0 0 1 8.413 3.488 11.824 11.824 0 0 1 3.48 8.413c-.003 6.557-5.337 11.892-11.893 11.892a11.9 11.9 0 0 1-5.688-1.448L.057 24zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.886a9.86 9.86 0 0 0 1.51 5.26l.66 1.052-.967 3.503 3.286-.916z"/></svg>
              WhatsApp Nadine
            </a>
            <Link
              href="/packages"
              className="inline-flex items-center rounded-full border border-[var(--color-ink)]/15 px-6 py-3 font-medium hover:bg-[var(--color-sand)]/40 transition-colors"
            >
              Browse packages
            </Link>
          </motion.div>
          ...
          <motion.div
            ...
            className="mt-8 flex flex-wrap gap-x-5 gap-y-2 text-sm text-[var(--color-muted)]"
          >
        ...
        {/* Hero image — right 45%, overhead flatlay placeholder */}
