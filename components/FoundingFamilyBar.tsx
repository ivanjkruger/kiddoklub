...
const BOOKED_COUNT = 4; // bump as deposits land; will move to Supabase counter later
const SLOT_LIMIT = 10;
...
export function FoundingFamilyBar() {
  ...
  return (
    <div className="bg-[var(--color-ink)] text-[var(--color-cream)] text-center text-sm py-2.5 px-4">
      ...
      <span className="font-semibold">QAR 1,400 in extras free with Klub Classic</span>
