...
// Lives at /bio so Nadine can paste kiddoklubdoha.com/bio in her IG profile bio link.
...
export const metadata = {
  ...
  description:
    "Book on WhatsApp · Build a quote · See gallery · Refer a friend.",
...
const LINKS: BioLink[] = [
  {
    href: "https://wa.me/97450318434?text=Hi%20Nadine!%20I%20saw%20your%20Instagram%20and%20I%27d%20love%20to%20book%20a%20setup.",
    title: "WhatsApp Nadine",
    sub: "Reply within 30 min during the day",
    cta: true,
  },
  {
    href: "/book",
    title: "Build a quote in 90 seconds",
    sub: "Theme · size · add-ons → instant WhatsApp",
  },
  {
    href: "/packages",
    title: "See packages and prices",
    sub: "Klub Mini, Classic, Signature",
  },
  {
    href: "/gallery",
    title: "Browse recent setups",
    sub: "Filter by venue and package",
  },
  {
    href: "/referral",
    ...
    <main className="min-h-screen px-5 py-10 max-w-md mx-auto">
      ...
      <ul className="space-y-3">
        {LINKS.map((l, i) => {
          ...
          const titleCls =
            "font-medium " + (l.cta ? "" : "text-[var(--color-ink)]");
          const subCls =
            "text-xs mt-0.5 " +
            (l.cta ? "opacity-90" : "text-[var(--color-muted)]");
          const inner = (
            <>
      ...
      <p className="text-center text-xs text-[var(--color-muted)] mt-10">
        © {new Date().getFullYear()} KiddoKlub · Doha, Qatar · WhatsApp +974
        5031 8434
      </p>
    </main>
  );
